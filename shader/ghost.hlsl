...
[numthreads(WIDTH, 1, 1)]
void mainDrawQuadraticPhase1(uint3 dispatchID : SV_DispatchThreadID)
{
	float2 index = dispatchID.xy;
	...
	float p = -(x * x + y * y) / (2 * computeConstants.focus1);//—¼“Ê
	//float p = (x * x + y * y) / (2 * computeConstants.focus1);//—¼‰š
...
[numthreads(WIDTH, 1, 1)]
void mainDrawQuadraticPhase2(uint3 dispatchID : SV_DispatchThreadID)
{
	float2 index = dispatchID.xy;
	...
	float p = -(x * x + y * y) / (2 * computeConstants.focus2);//—¼“Ê
	//float p = (x * x + y * y) / (2 * computeConstants.focus2);//—¼‰š
...
[numthreads(WIDTH, 1, 1)]
void mainDrawQuadraticPhase3(uint3 dispatchID : SV_DispatchThreadID)
{
	float2 index = dispatchID.xy;
	...
	float p = -(x * x + y * y) / (2 * computeConstants.focus3);//—¼“Ê
	//float p = (x * x + y * y) / (2 * computeConstants.focus3);//—¼‰š
...
[numthreads(WIDTH, 1, 1)]
void mainDrawQuadraticPhase4(uint3 dispatchID : SV_DispatchThreadID)
{
	float2 index = dispatchID.xy;
	...
	float p = -(x * x + y * y) / (2 * computeConstants.focus4);//—¼“Ê
	//float p = (x * x + y * y) / (2 * computeConstants.focus4);//—¼‰š
...
[numthreads(WIDTH, 1, 1)]
void mainDrawQuadraticPhase5(uint3 dispatchID : SV_DispatchThreadID)
{
	float2 index = dispatchID.xy;
	...
	float p = -(x * x + y * y) / (2 * computeConstants.focus5);//—¼“Ê
	//float p = (x * x + y * y) / (2 * computeConstants.focus5);//—¼‰š
